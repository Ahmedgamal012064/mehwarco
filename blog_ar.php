...
<head>
    ...
    <meta name="description" content="المدونة - المحور">
    <meta name="author" content="">

    <title>المدونة - المحور</title>
                ...
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item dropdown insights-dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="insightsDropdown">
                            <a class="dropdown-item active" href="blog_ar.php">المدونة</a>
                        ...
                        <div>
                            <div class="dropdown pull-right">
                                ...
                                <ul id="lang-switcher-list" class="dropdown-menu">
                                    <li>
                                        <a id="selectable_lang" href="blog.php" class="nav-link">
                        ...
                        echo '<div class="col-lg-4 col-md-6">
                            <div class="blog-card">
                                ...
                                <div class="blog-content">
                                    ...
                                    <a href="post.php?id=' . $post_id . '" class="btn-read-more">اقرأ المزيد</a>
                                </div>
                            </div>
                        </div>';
                    }
                } else {
                    echo '<div class="col-12 text-center"><p class="text-muted">لا توجد مقالات حالياً</p></div>';
                }
                ?>
            </div>
        </div>
