...
<head>
    ...
    <meta name="description" content="Partnerships - Mehwarco">
    <meta name="author" content="">

    <title>Partnerships - Mehwarco</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#reports">Reports</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li id="mini_nav" class="nav-item">
                        <div>
                            <div class="dropdown pull-right">
                                <a data-target="#" class="nav-link" href="partnerships.php" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                ...
                                <ul id="lang-switcher-list" class="dropdown-menu">
                                    <li>
                                        <a id="selectable_lang" href="partnerships_ar.php" class="nav-link">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Our Partners in Success</h3>
                </div>
            </div>
            <div class="row">
                <!-- Partner 1 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner1.png" alt="Partner 1" class="partner-logo">
                        <h4 class="partner-name">Partner Name 1</h4>
                    </div>
                </div>
                <!-- Partner 2 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner2.png" alt="Partner 2" class="partner-logo">
                        <h4 class="partner-name">Partner Name 2</h4>
                    </div>
                </div>
                <!-- Partner 3 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner3.png" alt="Partner 3" class="partner-logo">
                        <h4 class="partner-name">Partner Name 3</h4>
                    </div>
                </div>
                <!-- Partner 4 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner4.png" alt="Partner 4" class="partner-logo">
                        <h4 class="partner-name">Partner Name 4</h4>
                    </div>
                </div>
                <!-- Partner 5 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner5.png" alt="Partner 5" class="partner-logo">
                        <h4 class="partner-name">Partner Name 5</h4>
                    </div>
                </div>
                <!-- Partner 6 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner6.png" alt="Partner 6" class="partner-logo">
                        <h4 class="partner-name">Partner Name 6</h4>
                    </div>
                </div>
                <!-- Partner 7 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner7.png" alt="Partner 7" class="partner-logo">
                        <h4 class="partner-name">Partner Name 7</h4>
                    </div>
                </div>
                <!-- Partner 8 -->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="partner-card">
                        <img src="assets/dist/images/partnerships/partner8.png" alt="Partner 8" class="partner-logo">
                        <h4 class="partner-name">Partner Name 8</h4>
                    </div>
                </div>
            </div>
        </div>
